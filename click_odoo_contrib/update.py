...
def _update_db2(conn, database, update_all, i18n_overwrite, watcher=None):
...
def _update_db(database, update_all, i18n_overwrite, watcher=None):
    ...
    with conn.cursor() as cr, advisory_lock(cr, database):
        _update_db2(conn, database, update_all, i18n_overwrite, watcher)
